...
```{r, eval=FALSE}
save(ancom_rand_output, file="data/ancom_rand_output.RData")
```

```{r 1, eval=TRUE}
load("data/ancom_rand_output.RData")
...
physeq_FMT1_cold <- prune_taxa(taxa_sums(physeq_FMT1)>0, physeq_FMT1)
```
