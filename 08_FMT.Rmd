...
***Structural zeros***
```{r structural_zeros_fmt1}
# Extract structural zeros
structural_zeros <- ancom_rand_output_fmt1$zero_ind
...
***Structural zeros***
```{r structural_zeros_fmt1_2}
# Extract structural zeros
structural_zeros <- ancom_rand_output_cold$zero_ind
...
```{r 8, eval=FALSE}
save(ancom_rand_output_fmt2, file="data/ancom_rand_output_cold_fmt2.RData")
```
