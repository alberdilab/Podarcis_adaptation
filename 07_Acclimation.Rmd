...
```{r beta_neutral_nmds_plot_final_accli, results=TRUE, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
ggarrange(beta_q0n_nmds_accli, beta_q1n_nmds_accli, beta_q1p_nmds_accli, ncol=3, nrow=1, common.legend = TRUE, legend="right")
```

```{r data_accli, results=TRUE, fig.height=4, fig.width=10, fig.fullwidth=TRUE}
ggarrange(
  beta_q0n_nmds_accli,
  beta_q1n_nmds_accli,
  beta_q1p_nmds_accli,
