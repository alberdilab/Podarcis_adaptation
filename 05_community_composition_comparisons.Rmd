...
```{r beta_div_neutral_transplant3, echo=TRUE, results=FALSE,message=FALSE, warning=FALSE, comments=FALSE, include=FALSE}
...
transplants_metadata<-transplants_metadata %>%
  filter(Tube_code!="AD64"|Tube_code!="AD67")
...
```{r beta_div_neutral_treat_samples_1, echo=FALSE, results = TRUE, message=FALSE, warning=FALSE, comments=FALSE,include=FALSE}
nrow(transplant3)
```


```{r beta_div_neutral_transplant3_1, echo=TRUE, results=FALSE,message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE,include=FALSE}
...
```{r beta_div_neutral_transplant3_2, echo=TRUE, results=FALSE,message=FALSE, warning=FALSE, comments=FALSE,include=FALSE}
...
```{r beta_richness_permanova_transplant3_4, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_richness_permanova_transplant3_5, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_neutral_permanova_transplant3_4, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_neutral_permanova_transplant3_5, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_phylo_permanova_transplant3_4, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_phylo_permanova_transplant3_5, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_func_permanova_transplant3_4, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_func_permanova_transplant3_5, echo=FALSE, warning=FALSE, comments="", message=FALSE,include=FALSE, eval=FALSE}
pairwise<-pairwise.adonis(beta_div_func_transplant3$S,transplant3_arrange$type, perm=999)
pairwise%>%
  tt()
```

```{r beta_neutral_nmds_transplant3, echo=TRUE, warning=FALSE, comments="", message=FALSE, results="hide",include=FALSE, eval=FALSE}
...
```{r beta_neutral_nmds_transplant3_plot, eho=FALSE, results=FALSE,include=FALSE, eval=FALSE}
...
```{r beta_neutral_nmds_plot_transplant3_final, echo=FALSE, results=TRUE, fig.height=8, fig.width=10, fig.fullwidth=TRUE,include=FALSE, eval=FALSE}
ggarrange(p0, p1, p2, p3, ncol=2, nrow=2, common.legend = TRUE, legend="right")
```
