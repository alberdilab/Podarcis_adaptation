...
```{r beta_neutral_nmds, echo=FALSE, warning=FALSE, comments="", message=FALSE, results=TRUE, eval=FALSE}
...
```{r beta_neutral_nmds_treat, echo=TRUE, warning=FALSE, comments="", message=FALSE, results="hide", eval=FALSE}
...
beta_div_func_transplant3<-hillpair(data=transplant3.counts_func, q=1, dist=dist)
```
...
```{r beta_neutral_nmds_transplant3, echo=TRUE, warning=FALSE, comments="", message=FALSE, results="hide", eval=FALSE}
...
post1.counts_func <- temp_genome_counts[,which(colnames(temp_genome_counts) %in% rownames(post1))]
identical(sort(colnames(post1.counts_func)),sort(as.character(rownames(post1))))
...
beta_div_func_post1<-hillpair(data=post1.counts_func, q=1, dist=dist)
```
...
```{r beta_neutral_nmds_post1, echo=FALSE, warning=FALSE, comments="", message=FALSE, results="hide", eval=FALSE}
...
beta_div_func_post2<-hillpair(data=post2.counts_func, q=1, dist=dist)
```
...
```{r beta_neutral_nmds_post2, echo=FALSE, warning=FALSE, comments="", message=FALSE, results="hide", eval=FALSE}
