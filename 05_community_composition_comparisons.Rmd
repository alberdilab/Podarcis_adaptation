...
```{r beta_div_neutral_post6, echo=TRUE, results=FALSE,message=FALSE, warning=FALSE, comments=FALSE}
post6 <- meta  %>%
...
```{r beta_div_neutral_post6_1, echo=TRUE, results=FALSE,message=FALSE, warning=FALSE, comments=FALSE, eval=FALSE}
...
```{r data_post6_2, echo=TRUE, results = FALSE, message=FALSE, warning=FALSE, comments=FALSE}
#Arrange of metadata dataframe
