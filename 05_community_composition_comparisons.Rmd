...
adonis2(formula=beta_div_richness_post5$S ~ type*time_point, data=post5[labels(beta_div_richness_post5$S),], permutations=999) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_neutral_post5$S ~ type*time_point, data=post5[labels(beta_div_neutral_post5$S),], permutations=999) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_phylo_post5$S ~ type*time_point, data=post5[labels(beta_div_phylo_post5$S),], permutations=999) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_func_post5$S ~ type*time_point, data=post5[labels(beta_div_func_post5$S),], permutations=999) %>%
		as.matrix() %>%
		kable()
```
