...
adonis2(formula=beta_div_richness_accli1$S ~ time_point+species+individual, data=accli1[labels(beta_div_neutral_accli1$S),], permutations=999, strata=accli1$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_neutral_accli1$S ~ time_point+species+individual, data=accli1[labels(beta_div_neutral_accli1$S),], permutations=999, strata=accli1$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_phylo_accli1$S ~ time_point+species+individual, data=accli1[labels(beta_div_phylo_accli1$S),], permutations=999, strata=accli1$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_func_accli1$S ~ time_point+species+individual, data=accli1[labels(beta_div_func_accli1$S),], permutations=999, strata=accli1$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_richness_transplant3$S ~ species+time_point+type+individual, data=transplant3[labels(beta_div_richness_transplant3$S),], permutations=999, strata=transplant3$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_neutral_transplant3$S ~ species+time_point+type+individual, data=transplant3[labels(beta_div_neutral_transplant3$S),], permutations=999, strata=transplant3$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_phylo_transplant3$S ~ species+time_point+type+individual, data=transplant3[labels(beta_div_phylo_transplant3$S),], permutations=999, strata=transplant3$individual) %>%
		as.matrix() %>%
		kable()
```
...
adonis2(formula=beta_div_func_transplant3$S ~ species+time_point+type+individual, data=transplant3[labels(beta_div_func_transplant3$S),], permutations=999, strata=transplant3$individual) %>%
		as.matrix() %>%
		kable()
```
