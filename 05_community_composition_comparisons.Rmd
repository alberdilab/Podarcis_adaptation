...
p0<-beta_q0n_nmds_wild %>%
        ...
        scale_shape_manual(name="Type",
                           ...
                           labels=c("Cold control", "Hot control", "Cold treatment"),
...
p3<-beta_q1f_nmds_wild %>%
			...
			ggplot(., aes(x=NMDS1,y=NMDS2, color=Population, label=sample)) +
				cale_color_manual(name="Population",
                    breaks=c("Cold_wet","Hot_dry"),
                    labels=c("Cold","Hot"),
                    values=c('#008080',"#d57d2c")) +
        scale_shape_manual(name="Type",
...
pairwise<-pairwise.adonis(beta_div_neutral_transplant3$S,transplant3$type, perm=999)
pairwise
```
