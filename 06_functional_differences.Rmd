...
GIFTs_functions_community %>%
    ...
    ggplot(aes(x=trait,y=sample,fill=gift)) +
        ...
        facet_grid(time_point+type ~ ., scales="free",space="free")
```
...
```{r data_TM6, echo=FALSE,results=FALSE}
...
```{r biosynthesis_plot, echo=FALSE, results=TRUE}
p1 <-merge_gift_TM6 %>%
...
```{r degradation_plot, echo=FALSE, results=TRUE}
p2 <-merge_gift_TM6 %>%
...
```{r structure_plot, echo=FALSE, results=TRUE}
p3 <-merge_gift_TM6 %>%
...
```{r overall_plot, echo=FALSE, results=TRUE}
p4 <-merge_gift_TM6 %>%
...
```{r biosynthesis_plot_1, echo=FALSE, results=TRUE}
p1 <-merge_gift_wild %>%
...
```{r degradation_plot_1, echo=FALSE, results=TRUE}
p2 <-merge_gift_wild %>%
...
```{r structure_plot_1, echo=FALSE, results=TRUE}
p3 <-merge_gift_wild %>%
...
```{r overall_plot_1, echo=FALSE, results=TRUE}
p4 <-merge_gift_wild %>%
